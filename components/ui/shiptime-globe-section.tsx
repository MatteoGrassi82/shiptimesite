          ...
          <div className="md:hidden px-7 py-10">
            ...
            >
              ...
              <span style={{ color: ds.muted, fontWeight: 400 }}>
                {" "}and access a growing network of courier, LTL, and FTL carriers across Canada and the US. Every shipment routed through the fastest, most cost-effective path. Automatically.
              </span>
            </h2>
          </div>
