...
const STEPS = [
  {
    ...
    title: "Register free",
    body: "No contract, no sales call. Register in under a minute and be processing shipments right away if you don't need to set up integrations or your own carrier rates.",
  ...
  },
  {
    num: "2",
    eyebrow: "Day 1",
    title: "Connect your carrier rates and compare with ours",
    body: "Bring the rates you've negotiated and compare them with ShipTime's discounted rates. Every major carrier, one place.",
  ...
  },
  {
    ...
    title: "Ship the best rate in the platform",
    body: "Every shipment shows all rates side by side — yours and ours. Pick the best, print, done.",
