...
// with italic accent, avatar stack, CTA), photo right with floating pill chips
// and a stacked notifications card. No competitor framing.
...
export default function CoreHero({ photo = "/generated/alt-hero.png" }: { photo?: string | null }) {
  return (
    <section
    ...
    >
      <div className="mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-center" style={{ maxWidth: 1100 }}>
        ...
        <div>
          ...
          >
            ShipTime brings <strong style={{ color: NAVY, fontWeight: 600 }}>every carrier, one screen</strong> — compare rates, print labels, manage freight, and track every package from one platform. From your first shipment to your millionth.
          </p>
